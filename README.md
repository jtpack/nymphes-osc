...
- ## MIDI Controller Handling
  - ### Connect a MIDI controller (keyboard, sequencer, etc) input port by its name
    - Address: /connect_midi_controller_input
    - Arguments:
      - 0
        - Type: String
        - Description: Name of MIDI Port (as generated by mido.get_input_names())

  - ### Connect a MIDI controller (keyboard, sequencer, etc) output port by its name
    - Address: /connect_midi_controller_output
    - Arguments:
      - 0
        - Type: String
        - Description: Name of MIDI Port (as generated by mido.get_output_names())

  - ### Disconnect MIDI Controller Input Port
    - Address: /disconnect_midi_controller_input
    - Arguments: None

  - ### Disconnect MIDI Controller Output Port
...
- ## Miscellaneous Status Messages
  ...
  - ### MIDI Controller Output Connected
    - Description: A MIDI output port to a MIDI controller (out from nymphes-osc, in to controller) has been connected. Only one MIDI controller output can be connected at a time.
    - Address: /midi_controller_output_connected
    - Arguments:
      - 0
        - Type: String
        - Description: The name of the MIDI controller's port
  
  - ### MIDI Controller Input Disconnected
    - Description: The previously-connected MIDI controller input has been disconnected.
    - Address: /midi_controller_input_disconnected
    - Arguments:
      - 0
        - Type: String
        - Description: The name of the MIDI controller's port

  - ### MIDI Controller Output Disconnected
    - Description: The previously-connected MIDI controller output has been disconnected.
    - Address: /midi_controller_output_disconnected
    - Arguments:
      - 0
        - Type: String
        - Description: The name of the MIDI controller's port
